...
class LoginHandler(BaseHandler):
	...
	def get(self):
		...
		# 	</form>
		# 	""")
		self.render("login.html",titel="登录",error=None)
...
def post(self):
	...
	if not username or not password:
		...
		# </form>
		# """)
		return self.render("login.html",titel="登录",error="用户名或密码不能为空或输入了无效数据")
	...
	if not UserRepository.verify_user(username,password):
		...
		# 	</form>
		# 	""")
		return self.render("login.html",titel="登录",error="用户名或密码错误")
